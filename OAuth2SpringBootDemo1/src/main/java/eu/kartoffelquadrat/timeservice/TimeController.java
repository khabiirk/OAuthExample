...
public class TimeController {
  ...
  /**
   * Gateway method to access service functionality - may be replaced by other implementations,
   * depending the feature selection.
   *
   * <p>Only registered users (adherent to the role "TIMEUSER" can access this resource).
   * See Users defined
  ...
  /**
   * Dummy method to demonstrate that any resources without a "PreAuthorize" clause
   * can be accessed as usually, even
   * if they math the "/api/**" URL pattern that enables the
   * securitycontext in "ResourceServerConfiguration".
   *
